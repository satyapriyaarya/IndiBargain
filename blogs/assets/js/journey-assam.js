...
function renderJourney(items) {
    ...
    journeyGrid.innerHTML = items
        .map((entry, index) => `
            <article class="post-card" data-link="/blogs/journey/assam/day/#${encodeURIComponent(entry.slug)}" style="cursor: pointer;">
                ...
                <p><a href="/blogs/journey/assam/day/#${encodeURIComponent(entry.slug)}">Read this part →</a></p>
            </article>
        `)
        .join("");
