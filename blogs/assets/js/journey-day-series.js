...
function getTravelEssentials(entry) {
    ...
    const profiles = {
        goa: {
            ...
            bestTime: "November to February is the prime window: dry weather, cooler temperatures (25-30°C), all beaches open, and events like Sunburn Festival (December) and Goa Carnival (February-March). October is quieter and cheaper. Avoid June to September for beach travel; monsoon keeps most shacks closed.",
        ...
        rameshwaram: {
            howToReach: "Madurai airport is the most practical gateway (2-3 hours by road/rail to Rameshwaram). Direct trains like the Rameswaram Express run from Chennai and Madurai. The iconic Pamban Bridge is the rail route entry into the island — one of India's most scenic rail crossings.",
            ...
            bestTime: "October to March is ideal: dry weather, manageable temple crowds, and comfortable coastal exploration. April-May becomes intensely hot (35-40°C). Avoid during peak pilgrimage festivals unless you specifically want that experience — crowds can triple.",
        ...
        "golden-triangle": {
            ...
            interesting: "Pre-book all monument tickets online (Archaeological Survey of India website) to skip physical queues. Monument days consistently produce better experiences with a 6:30 AM start — light is better, queues are shorter, and heat is manageable.",
            ...
            bestTime: "October to March is the classic window: comfortable temperatures (12-25°C), clear skies, and all attractions open. December-January has cold nights (5-8°C in Delhi/Jaipur) but beautiful daytime clarity. April-May is extreme heat (40+°C). Monsoon (July-September) keeps monuments busy but less photogenic.",
        ...
        jaisalmer: {
            ...
            whereToEat: "Fort-view rooftop restaurants in the city core for evening meals with silhouette views. Midtown Jaisalmer eateries for morning snacks and chai. Desert camp kitchens for dinner — the combination of campfire, stars, and Rajasthani cooking is the experience, not just the food.",
            ...
            photographyTips: "Jaisalmer Fort is best photographed in the pre-sunset hour (4:30-5:30 PM) when the golden sandstone glows warmest. Bada Bagh cenotaphs cast dramatic long shadows at sunset. Sam dunes work best in the final 20 minutes before the sun sets — the angular light creates dune ridgeline shadows. Night sky photography is exceptional at Sam dunes with no city light pollution.",
            bestTime: "October to February: cool days (20-28°C), cold nights (5-10°C), all activities available. March is warm but manageable. Avoid April-September: summer temperatures reach 42-48°C during day. Desert Festival (held in Jaisalmer in February) adds folk performances, camel races, and turbaning competitions.",
            ...
            safetyNotes: "Carry adequate water during desert excursions — dehydration risk is high. Use SPF 50+ sun protection. Never leave organized safari groups in the dunes after dark. Keep cash (ATMs sparse in desert zones). Check camp booking reviews before paying advance deposits."
        },
        udaipur: {
            ...
            interesting: "Book a boat ride on Lake Pichola specifically at dusk (45 minutes before sunset) and remain on the lake until 20 minutes after sunset — the City Palace and Jag Niwas island palace illumination in twilight is one of the best sustained visual experiences in Rajasthan.",
            ...
            bestTime: "September to March: October-March is peak with comfortable temperatures (20-30°C). Monsoon (July-September) fills all lakes to full capacity and the Monsoon Palace view is especially stunning — this is actually a hidden gem season for photographers. Avoid extreme summer months (April-June) when temperatures hit 38-42°C.",
        ...
        jaipur: {
            ...
            whatToEat: "Pyaaz kachori is Jaipur's signature snack — eat it hot from Rawat Mishthan Bhandar or Samrat Restaurant. Dal baati churma for a full traditional meal. Laal maas (slow-cooked mutton in red chilli gravy) at Spice Court or Suvarna Mahal. Ghewar (lattice flour sweet) during Teej season. Lassi from Old Jaipur should be thick and served in an earthen matka.",
            ...
            interesting: "Nahargarh Fort at night (open until 11 PM some days) gives one of the best city-light panoramas in India — the entire walled pink city glows in street lamps below while the fort remains in dark stone silhouette above.",
            gettingAround: "Day cabs (INR 800-1,500) are the best option for fort circuits since hill locations are not auto-accessible. Metro is useful for Badi Chaupar to railway station corridor. Autos and cycle-rickshaws work for Old City bazaar navigation. Avoid driving in Old City during market hours (10 AM - 6 PM) — lane congestion is severe.",
            ...
            bestTime: "October to March is optimal: comfortable temperatures (15-28°C during day), low humidity. January sees Jaipur Literature Festival (one of Asia's largest). Teej Festival (July-August) and Gangaur Festival (March-April) add cultural dimension for interested visitors. Avoid April-June (40-45°C daytime heat).",
        ...
        kerala: {
            ...
            interesting: "Houseboat food in Alleppey improves significantly if you brief the cook before departure: request fresh local fish, traditional preparations, and ask to skip pre-packaged items — most boathouses accommodate this with same-day sourcing.",
        ...
        assam: {
            ...
            interesting: "The Majuli ferry crossing from Neamati Ghat is itself an experience: the boat carries vehicles, cycles, goats, produce, and passengers simultaneously. Go on the upper deck for a complete view of the Brahmaputra's width — at certain seasons it stretches beyond visible horizon.",
            gettingAround: "Guwahati: Ola/Uber available and effective within the city. Kaziranga to Majuli: hire a private car with driver from Kaziranga (5-6 hours total including ferry). Majuli: rent a bicycle (INR 100-150/day) or moped — the island is flat and roads are manageable. Sivasagar: local autos and shared tempos connect major historical sites.",
            ...
            safetyNotes: "Carry malaria prevention measures if visiting forest zones. Respect all safari rules strictly at Kaziranga — vehicles have been charged by rhinos in documented incidents. Keep ferry schedule flexibility for Majuli as river conditions change rapidly. Carry sufficient cash as ATMs are sparse beyond Guwahati."
        },
        valley: {
            ...
            whereToEat: "Route dhabas at Devprayag, Rudraprayag, and Pipalkoti for hot meals during road transit. Pulna has small tea stalls for chai before the trek starts. Ghangaria has lodges with attached kitchens — food quality varies, so choose busy places with turnover. Avoid undercooked meals at altitude.",
            ...
            safetyNotes: "Never trek solo beyond Pulna. Altitude sickness (AMS) risk increases above Ghangaria (3,048 m) — descend if you develop persistent headache, nausea, or confusion. Carry Diamox only if prescribed. Avoid valley entry after noon. Flash floods can occur without warning on the trek route after rain."
        }
    };
    ...
    return {
        ...
        {
            test: /golden-triangle|delhi|agra|taj|fatehpur/,
            value: {
                howToReach: "Start in Delhi (Indira Gandhi International Airport). Delhi-Agra is best covered by Gatimaan Express (100 min) or expressway road (3-4 hours). Agra-Jaipur connects by road via Fatehpur Sikri (4-5 hours). The full triangle loop can also be done in reverse. Pre-book intercity transport to avoid day-of price surges.",
                whatToEat: "Delhi: chhole bhature, paranthas in Chandni Chowk, dahi bhalle, butter chicken at its origin (Moti Mahal). Agra: petha (unique sweet), Mughlai biryani, bedai with puri, agre ka halwa. Jaipur: pyaaz kachori, dal baati churma, laal maas, ghewar dessert, lassi from Old Jaipur.",
                whereToEat: "Old Delhi food lanes (Paranthe Wali Gali, Dariba Kalan) for street food. Joney's Place in Agra for budget-friendly Indian and Western options. LMB (Laxmi Misthan Bhandar) in Jaipur for authentic sweets and Rajasthani thali.",
        ...
        },
        {
            ...
            value: {
                howToReach: "Lokpriya Gopinath Bordoloi International Airport (Guwahati) is the main hub with connections to Delhi, Kolkata, Mumbai, and Bangalore. NH27 connects Guwahati to Kaziranga (190 km, 4-5 hours). Majuli is accessed via Jorhat and the Neamati/Nimati Ghat ferry. Sivasagar is 380 km from Guwahati on NH715.",
                whatToEat: "Assamese thali: rice, dal, masor tenga (fish in sour tomato or elephant apple gravy), khar (alkaline-cooked vegetables), pitika (mashed preparations), bamboo shoot sabzi, and black sesame chutney. Joha rice (short-grain aromatic variety) is distinctive. In Majuli: traditional Mising tribe food including smoked pork preparations and fermented fish.",
                whereToEat: "Guwahati: Paradise Restaurant near Fancy Bazaar for classic Assamese fish dishes, local dhabas on AT Road for quick thalis. Kaziranga: resort dining or the small roadside restaurants in Kohora for fresh fish. Majuli: homestay meals cooked fresh are the best food experience in the entire route.",
                whatToBuy: "Assam CTC and orthodox tea from verified estate outlets. Handloom products: muga silk (natural golden silk from Sualkuchi), gamocha (traditional cotton towel with woven border), mekhela chador (two-piece traditional women's garment). Bamboo and cane crafts from Majuli artisans. Organic rice products from roadside cooperative stalls.",
                interesting: "The Majuli ferry crossing from Neamati Ghat is itself an experience: the boat carries vehicles, cycles, goats, produce, and passengers simultaneously. Go on the upper deck for a complete view of the Brahmaputra's width — at certain seasons it stretches beyond visible horizon.",
                gettingAround: "Guwahati: Ola/Uber available and effective. Kaziranga to Majuli: hire a private car with driver from Kaziranga (5-6 hours total including ferry). Majuli: rent a bicycle (INR 100-150/day) or moped — the island is flat and roads are manageable. Sivasagar: local autos and shared tempos connect major historical sites.",
                photographyTips: "Kaziranga safari: use longest available focal length (200-400mm) for rhino and elephant shots; early morning safari gives best light. Majuli mask-making workshops: close-up documentary photography of the artisan's hands and paint process. Brahmaputra river shots work best from the Sivasagar Joysagar Tank (largest artificial tank in India at sunset).",
                bestTime: "October to April is the best window. November-February is peak for Kaziranga (coolest temperatures, dry forest, clearest views). Majuli is best November-March when river levels are low and island roads are dry. Avoid June-September monsoon period when Kaziranga partially floods and Majuli ferries are unpredictable.",
                budgetGuide: "Budget per day (shared, mid-range): accommodation INR 1,000-2,500, meals INR 400-900, local transport INR 500-1,200, safari INR 700-1,500. Total daily range: INR 2,600-6,100. An 8-day Assam trip runs INR 21,000-49,000 per person.",
                safetyNotes: "Carry malaria prevention medication if visiting forest zones. Respect all safari rules strictly at Kaziranga — vehicles have been overturned by rhinos in documented incidents. Keep ferry schedule flexibility for Majuli as river conditions change rapidly. Carry sufficient cash as ATMs are sparse in rural Assam."
            }
        },
        {
            ...
            value: {
                howToReach: "Rishikesh (240 km from Delhi via NH58) or Haridwar are the starting points. Rishikesh to Joshimath is 253 km (7-9 hours by road). From Joshimath, go 25 km to Govindghat. Trek starts at Pulna (2 km beyond Govindghat by shared taxi). No vehicle access beyond Pulna; 14 km trek to Ghangaria from Pulna.",
                whatToEat: "Trek fuel: high-carb, easy-digest meals. Dal-rice, rajma-chawal, and aloo paratha are the staples on route. At Ghangaria lodges, cooked meals are available in basic form. Carry: roasted makhana, trail mix with almonds and raisins, glucose biscuits, electrolyte sachets, and instant oat packets for early starts.",
                whereToEat: "Route dhabas at Devprayag, Rudraprayag, and Pipalkoti for hot meals during road transit. Pulna has small tea stalls for chai before the trek starts. Ghangaria has lodges with attached kitchens — food quality varies, so choose busy places with turnover. Avoid undercooked meals at altitude as digestion is already stressed.",
                whatToBuy: "Gear before trek: buy trek poles, rain ponchos, waterproof bag covers, and quick-dry socks in Rishikesh (cheaper than at trail). Valley of Flowers National Park entry fee: INR 150 per person per day (Indian), INR 600 per day (foreign national). Hemkund Sahib entry is free. Carry small denomination notes for dhabas, porters, and mule-hire.",
                interesting: "The Valley of Flowers hosts over 600 species of wild alpine flowers including Brahmakamal, Blue Poppy, Cobra Lily, and Himalayan Balsam. Flowering peak is typically mid-July to mid-August. Each week within this window brings different species to dominance — a second visit a week after the first shows a noticeably different floral landscape.",
                gettingAround: "Delhi to Rishikesh: Volvo buses (6-7 hours, INR 400-600) or train to Haridwar then cab. Rishikesh to Govindghat: shared taxis/cabs, departing Rishikesh by 5 AM for Govindghat arrival by 2 PM. Pulna to Ghangaria: 13-14 km trek (4-6 hours at steady pace) or mule hire (INR 1,200-2,000). Mules cannot carry people on steep valley sections.",
                photographyTips: "Valley of Flowers: shoot in cloud-break windows (often 8-10 AM before afternoon cloud build-up) for soft natural light with no harsh shadows. Wide-angle lens for the valley floor panorama, macro for individual flower close-ups. Hemkund Lake at noon has the clearest sky reflection when sun is overhead. Bring a polarising filter for high-altitude sky shots.",
                bestTime: "Mid-July to mid-August: maximum flower variety and bloom density. Second half of August into September: fewer tourists, later-season flowers like Brahmakamal. Early July: snow still present, some flowers just emerging. October onwards: trail closure for the season. Do not plan the valley visit before June 1 (official opening) or after October 15.",
                budgetGuide: "Budget per person for 10-day Valley of Flowers trip: Delhi-Rishikesh transport INR 600-1,200, accommodation along route INR 4,000-8,000 (8 nights), meals INR 3,000-5,000, park entry fees INR 1,200-1,800, porter/mule if needed INR 1,500-3,000. Total: INR 10,300-19,000 per person.",
                safetyNotes: "Never trek solo beyond Pulna. Altitude sickness (AMS) risk increases above Ghangaria (3,048 m) — descend if you develop persistent headache, nausea, or confusion. Carry Diamox only if prescribed. Avoid valley entry after noon to ensure daylight for return. Flash floods can occur without warning on the trek route after rain."
            }
        }
    ];
